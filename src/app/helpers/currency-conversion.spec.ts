...
describe('Currency Conversion', () => {
  ...
  describe('calculateCurrencyConversionOutputAmount', () => {
    it('should halve output for equal value currencies', () => {
      const result = calculateCurrencyConversionOutputAmount(manaCurrency, manaCurrency, 100);
    ...
    it('should convert higher value to lower value currency with loss', () => {
      ...
      const result = calculateCurrencyConversionOutputAmount(fireSliverCurrency, manaCurrency, 25);
    ...
    it('should convert lower value to higher value currency with loss', () => {
      ...
      const result = calculateCurrencyConversionOutputAmount(manaCurrency, fireSliverCurrency, 100);
    ...
    it('should handle complex conversion ratios', () => {
      ...
      const result = calculateCurrencyConversionOutputAmount(fireShardCurrency, fireSliverCurrency, 10);
  ...
  describe('calculateCurrencyConversionInputAmount', () => {
    it('should double input for equal value currencies', () => {
      const result = calculateCurrencyConversionInputAmount(manaCurrency, manaCurrency, 50);
    ...
    it('should require double input for higher to lower value conversion', () => {
      ...
      const result = calculateCurrencyConversionInputAmount(fireSliverCurrency, manaCurrency, 62);
    ...
    it('should require double input for lower to higher value conversion', () => {
      ...
      const result = calculateCurrencyConversionInputAmount(manaCurrency, fireSliverCurrency, 10);
  ...
  describe('round-trip conversion prevention', () => {
    it('should prevent exact round-trip conversion', () => {
      ...
      const fireSliverAmount = calculateCurrencyConversionOutputAmount(manaCurrency, fireSliverCurrency, startAmount);
      
      // Convert back from Fire Sliver to Mana
      const finalManaAmount = calculateCurrencyConversionOutputAmount(fireSliverCurrency, manaCurrency, fireSliverAmount);
    ...
    it('should be consistently lossy regardless of conversion direction', () => {
      // Convert A -> B
      const outputAB = calculateCurrencyConversionOutputAmount(manaCurrency, fireSliverCurrency, 100);
      
      // Calculate what input is needed for the same output
      const inputForSameOutput = calculateCurrencyConversionInputAmount(manaCurrency, fireSliverCurrency, outputAB);
